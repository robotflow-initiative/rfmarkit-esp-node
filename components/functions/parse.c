...
esp_err_t parse_imu_reading(gy95_t * p_gy, 
    ...
    cJSON_AddNumberToObject(pRoot, "accel_x", msg_holder.accel_x * default_multiplier.accel_x * (1U << p_gy->acc_scale));
    cJSON_AddNumberToObject(pRoot, "accel_y", msg_holder.accel_y * default_multiplier.accel_y * (1U << p_gy->acc_scale));
    cJSON_AddNumberToObject(pRoot, "accel_z", msg_holder.accel_z * default_multiplier.accel_z * (1U << p_gy->acc_scale));
    cJSON_AddNumberToObject(pRoot, "gyro_x", msg_holder.gyro_x * default_multiplier.gyro_x * (1U << p_gy->gyro_scale));
    cJSON_AddNumberToObject(pRoot, "gyro_y", msg_holder.gyro_y * default_multiplier.gyro_y * (1U << p_gy->gyro_scale));
    cJSON_AddNumberToObject(pRoot, "gyro_z", msg_holder.gyro_z * default_multiplier.gyro_z * (1U << p_gy->gyro_scale));
    ...
    cJSON_AddNumberToObject(pRoot, "mag_x", msg_holder.mag_x * default_multiplier.mag_x * (1U << p_gy->mag_scale));
    cJSON_AddNumberToObject(pRoot, "mag_y", msg_holder.mag_y * default_multiplier.mag_y * (1U << p_gy->mag_scale));
    cJSON_AddNumberToObject(pRoot, "mag_z", msg_holder.mag_z * default_multiplier.mag_z * (1U << p_gy->mag_scale));
