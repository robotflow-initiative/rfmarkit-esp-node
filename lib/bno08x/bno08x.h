//
// Created by liyutong on 2024/6/6.
//
...
//FIXME: void BNO08x_queue_tare_command(BNO08x* device,uint8_t command, uint8_t axis = TARE_AXIS_ALL, uint8_t rotation_vector_basis = TARE_ROTATION_VECTOR);
...
void IRAM_ATTR hint_handler(void* arg);
...
// Add your C function prototypes here
