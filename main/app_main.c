...
void app_main(void) {
    ...
    launch_task_multicore(app_tcp_client, "app_tcp_client", 4096,serial_queue, 2, tcp_task, 0x1);
    ...
    launch_task(app_tcp_client, "app_tcp_client", 4096, serial_queue, 2, tcp_task);
